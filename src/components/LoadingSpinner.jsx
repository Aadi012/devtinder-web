...
export const FullScreenLoader = ({ message = 'Loading Homio...' }) => {
  return (
    <div className="fixed inset-0 bg-linear-to-br from-pink-100 via-purple-50 to-indigo-100 flex items-center justify-center z-50">
